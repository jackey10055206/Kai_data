...
from process_data import machine_num, machine_series, file_dir, usecols, gas_column, Real_time, Machine_time, Rtime
...
# 儲存 Excel
output_excel = f"{machine_num}_{machine_series}_{Rtime[0][5:7]}_{Rtime[0][8:10]}_{gas_column[0]}.xlsx"
